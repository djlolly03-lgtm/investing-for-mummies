...
END=44.42
w=wave.open('song45-st.wav'); sr=w.getframerate()
...
LINES=[(0.00,2.52,"Girls just wanna have fun"),(4.14,6.46,"Girls just wanna have fun"),
 (7.98,10.04,"Spend a little, save a little"),(11.04,12.02,"Have some fun"),
 (15.00,19.30,"Save and invest and have your fun"),(20.02,24.06,"You can do both, you don't need just one"),
 (25.16,28.44,"Smart with money, still have fun"),(28.98,33.18,"That's Investing for Mummies"),
 (36.44,39.18,"Girls just wanna have fun"),(40.44,43.08,"Girls just wanna have fun")]
CAPS=[]
...
os.makedirs('caps45',exist_ok=True)
def fit(t):
...
for i,(s,e,txt) in enumerate(CAPS):
    ...
    p=f'caps45/cap{i:02d}.png'; im.save(p)
    meta.append({'file':p,'start':round(s,3),'end':round(e,3),'h':H,'text':txt})
json.dump(meta,open('caps45/meta.json','w'),indent=1)
