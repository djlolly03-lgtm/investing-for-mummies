...
const ARMS = [
  ['w1', { tuneRackSteps: 8, tuneTipSteps: 6, tuneWritesPerStep: 1 }],
  ['w2', { tuneRackSteps: 8, tuneTipSteps: 6, tuneWritesPerStep: 2 }],
  ['w3', { tuneRackSteps: 8, tuneTipSteps: 6, tuneWritesPerStep: 3 }],
  ['ramp12', { tuneRackSteps: 12, tuneTipSteps: 10, tuneWritesPerStep: 1 }],
];
